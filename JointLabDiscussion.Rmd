...
## Ex 1: Can we use trap catches and spray turn-on dates to assess pesticide efficacy?
...
## Ex 2: Can we see the effects of mating disruption?
...
ggplot(temp1, aes(x = DayOfYear.y, y = Males, group = Site.y, colour = TrapType)) +
    scale_color_manual(values = pal) +
    geom_point(size=2) +
    geom_vline(aes(xintercept = DayOfYear.x,
                   colour = "Product..Agrian.",
