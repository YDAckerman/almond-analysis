...
# We can see general patterns in seasonal NOW density
...
## Can we use trap catches and spray / turn-on dates to assess pesticide and MD efficacy?
...
- Under each treatment type (a variation of pestide &/or MD use) insect variables have different meanings. In particular: comparing male trap catches between treatments is meaningless.
...
- can we optimize pesticide application dates?
...
## Best practices for MD?

- When is the best time to turn on a puffer?
- Where should they be located?
- What concentration of pheromone is most efficient?
...
- We'll use a poisson-distributed response given by: $$PDT = \frac{\mbox{nuts damaged by NOW}}{\mbox{total nuts harvested}}$$
...
- ex: $$PDT \sim M1 + E2 + F3$$ $$PDT \sim E3 + F1$$
- Finally, we'll use some different metrics to decide which model is the best.
...
## Female counts appear to be, on average, the best predictor for nut damage.
