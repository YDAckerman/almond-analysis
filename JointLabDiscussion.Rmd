...
- _A._ _flavus_ create aflatoxin which is terribly carcinogenic.
...
This is a subset of variables we have data on:
```{r, echo = FALSE}
colnames(dmg[, c(1:40)])
```
...
c_md <- subset(c,Trtmnt %in% c("EMD", "LMD", "100%MD", "50%MD", "100%C", "50%C", "1MD", "2MD", "1CMD", "2CMD"))
